				...
				<div class="container">
					...
					<div class="collapse navbar-collapse main-menu" style="margin-right:20px;">
                        ...
                        <div class="header-btn d-inline-flex">
                            <a href="contact.html" class="btn-default">donate now</a>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-content-body wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <a href="contact.html" class="btn-default btn-highlighted"><span>Contact now</span></a>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-content">
                        ...
                        <div class="about-us-footer wow fadeInUp" data-wow-delay="1s">
                            <a href="contact.html" class="btn-default">Our mission</a>
                        </div>
                        <!-- About Us Footer End -->
                    </div>
                    <!-- About Content End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mission-image">
                        ...
                        <div class="mission-img">
                            <figure class="image-anime reveal">
                                <img src="images/church inside.jpg" alt="">
                            </figure>
                        </div>
                        <!-- Mission Image End -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-content">
                        ...
                        <!-- About Us Footer Start -->
                        <div class="about-us-footer wow fadeInUp" data-wow-delay="1s">
                            <a href="contact.html" class="btn-default">Buy us Brick</a>
                        </div>
                        <!-- About Us Footer End -->
                    </div>
                    <!-- About Content End -->
                ...
                <div class="col-lg-6 col-md-4">
                    <div class="intro-video-box">
                        ...
                        <div class="video-play-button">
                            <a href="#pdfModal"  data-cursor-text="Play" onclick="showModal()">
